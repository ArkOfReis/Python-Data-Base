...
# Part
part_text = StringVar()
part_label = Label(app, text='Username', font=('bold', 14), pady=20)
part_label.grid(row=0, column=0)
part_entry = Entry(app, textvariable=part_text)
part_entry.grid(row=0, column=1)
# Customer
customer_text = StringVar()
customer_label = Label(app, text='Password', font=('bold', 14))
customer_label.grid(row=0, column=2)
customer_entry = Entry(app, textvariable=customer_text)
customer_entry.grid(row=0, column=3)
# Retailer
retailer_text = StringVar()
retailer_label = Label(app, text='Email', font=('bold', 14))
retailer_label.grid(row=1, column=0)
retailer_entry = Entry(app, textvariable=retailer_text)
retailer_entry.grid(row=1, column=1)
# Price
price_text = StringVar()
price_label = Label(app, text='Software', font=('bold', 14))
price_label.grid(row=1, column=2, sticky=N)
...
app.title('Email & Password Database')
